            ...
            <div class="row">
                <div class="col-xs-12 col-md-5">
                    <div class="booking">
                        <div class="form-back">
                            <div class="form">
                                <p>Your order: <span>100</span>$</p>
                                <div class="note">


                                    <p> <span><i class="fas fa-regular fa-circle-exclamation"></i></span>
                                        We accept payment form Visa and Paypal. Choose one to countinue!</p>

                                </div>

                                <div class="choice">
                                    <button onclick="visa('app')">
                                        Visa
                                    </button>
